...
export type ActiveExerciseResult = Readonly<{ workoutExerciseId: string; exerciseId: string; performedExerciseId?: string; skipped: boolean; completed: boolean; difficulty?: ExerciseDifficulty; sets: readonly ExerciseSetResult[] }>;
